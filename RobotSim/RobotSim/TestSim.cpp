...
{
    // RP::Map map;
    // map.add_obstacle(RP::point{-4.0f, 5.0f}, RP::point{4.0f, 5.0f});
    // map.add_obstacle(RP::point{-4.0f, 6.0f}, RP::point{4.0f, 6.0f});
    // map.add_obstacle(RP::point{1.0f, 7.0f}, RP::point{3.0f, 10.0f});
